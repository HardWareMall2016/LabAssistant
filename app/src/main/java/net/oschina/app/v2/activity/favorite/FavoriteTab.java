...
public enum FavoriteTab {
	...
	SOFTWARE(0, FavoriteList.TYPE_SOFTWARE, R.string.frame_title_my_favorite, MyFavoriteFragment.class), 
	POST(1, FavoriteList.TYPE_POST, R.string.frame_title_favorite_me,FavoriteMeFragment.class);
