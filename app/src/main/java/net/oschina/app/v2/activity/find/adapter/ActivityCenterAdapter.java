...
public class ActivityCenterAdapter extends ListBaseAdapter {
	...
	protected View getRealView(int position, View convertView, ViewGroup parent) {
		...
		ActivityCenter ac = (ActivityCenter) _data.get(position);
		vh.tv_time.setText(DateUtil.parseTime(ac.getInputtime()));
		vh.tv_title.setText(ac.getTitle());
		ImageLoader.getInstance().displayImage(String.format(ApiHttpClient.DEV_API_IMAGE_URL, ac.getThumb()), vh.iv_daily);
		return convertView;
	}
