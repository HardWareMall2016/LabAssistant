...
public class MallTabPagerAdapter extends SlidingTabPagerAdapter {
	...
	public MallTabPagerAdapter(FragmentManager mgr, Context context,
			ViewPager vp) {
		super(mgr, MallTab.values().length, context.getApplicationContext(), vp);

		MallTab[] values = MallTab.values();
	...
	public int getCount() {
		// TODO Auto-generated method stub
		return MallTab.values().length;
	}

	@Override
	public CharSequence getPageTitle(int i) {
		// TODO Auto-generated method stub
		MallTab tab = MallTab.getTabByIdx(i);
		int resId = 0;
		CharSequence title = "";
		if (tab != null) {
			resId = tab.getTitle();
