...
public class TotalRankFragment extends BaseListFragment {
	protected static final String TAG = WeekRankFragment.class.getSimpleName();
	private static final String CACHE_KEY_PREFIX = "totalranklist_";
	...
	protected ListEntity parseList(InputStream is) throws Exception {
		...
		System.out.println(result.toString() + "！！！！！！总排行");
		is.close();
		return wrlist;
	}
