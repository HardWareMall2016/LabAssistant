...
public class HomeDetailFragment extends BaseFragment implements
		EmojiTextListener, EmojiFragmentControl, OnOperationListener,
		OnItemClickListener{
	protected static final String TAG = HomeDetailFragment.class
			.getSimpleName();
...
//			handleReplyComment(comment);
	...
	private void handleReplyComment(Comment comment) {
		...
		UIHelper.showReplyCommentForResult(getActivity(), REQUEST_CODE, false, mTweetId,
