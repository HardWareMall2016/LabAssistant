...
public class ShareDialog extends CommonDialog implements
	...
	private ShareDialog(Context context, int defStyle) {
		...
		shareView.findViewById(R.id.ly_share_icon_qq).setOnClickListener(this);
		shareView.findViewById(R.id.ly_share_icon_qqzone).setOnClickListener(this);
	...
	if (id == R.id.ly_share_sina_weibo) {
		 ...
		 else if (id == R.id.ly_share_icon_qq) {
				media = SHARE_MEDIA.QQ;
			}
		 else if (id == R.id.ly_share_icon_qqzone) {
