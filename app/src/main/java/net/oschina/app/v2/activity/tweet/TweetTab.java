...
public enum TweetTab {
    ...
    ASK(0,TweetList.CATALOG_LASTEST, R.string.frame_title_tweet_ask, TweetFragment.class),
    HELP(1, TweetList.CATALOG_HOT,R.string.frame_title_tweet_help, FansFragment.class);
    private Class<?> clz;
    private int idx;
    private int title;
    private int catalog;
