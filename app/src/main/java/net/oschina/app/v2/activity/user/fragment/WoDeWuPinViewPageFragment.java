...
import net.oschina.app.v2.activity.user.adapter.WoDeWuPinPagerAdapter;
...
public class WoDeWuPinViewPageFragment extends Fragment implements
		OnPageChangeListener {

	private PagerSlidingTabStrip mTabStrip;
	private ViewPager mViewPager;
	private WoDeWuPinPagerAdapter mTabAdapter;
	...
	/*		mTabAdapter = new FavoriteTabPagerAdapter(getChildFragmentManager(),
			...
			mTabAdapter=new WoDeWuPinPagerAdapter(getChildFragmentManager(),getActivity(),mViewPager);
		}
