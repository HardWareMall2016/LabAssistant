...
public class TweetList extends Entity implements ListEntity {
	...
	public final static int TYPE_WEEKBILLBOARD = 0x01;
	public final static int TYPE_TOTALBILLBOARD = 0x02;

	public final static int CATALOG_LASTEST = 0;
	public final static int CATALOG_HOT = -1;
//	public final static int TYPE_WEEKBILLBOARD = 1;
//	public final static int TYPE_TOTALBILLBOARD = 2;
