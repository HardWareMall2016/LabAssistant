			    	...
			    	case XmlPullParser.START_TAG:
			    		...
			    		else if (user != null)
			    		{
			    			if (tag.equalsIgnoreCase("id")) {
								user.setId(StringUtils.toInt(xmlParser.nextText(),0));
							}else if(tag.equalsIgnoreCase("nickname")){
								user.setNickname(xmlParser.nextText());
							}else if(tag.equalsIgnoreCase("head")){
								user.setHead(xmlParser.nextText());
							}else if(tag.equalsIgnoreCase("realname_status")){
								user.setRealname_status(StringUtils.toInt(xmlParser.nextText()));
							}else if(tag.equalsIgnoreCase("invitation")){
								user.setInvitation(StringUtils.toInt(xmlParser.nextText()));
							}else if(tag.equalsIgnoreCase("qnum")){
								user.setQnum(StringUtils.toInt(xmlParser.nextText()));
							}else if(tag.equalsIgnoreCase("cnum")){
								user.setCnum(StringUtils.toInt(xmlParser.nextText()));
							}else if(tag.equalsIgnoreCase("anum")){
								user.setAnum(StringUtils.toInt(xmlParser.nextText()));
							}else if(tag.equalsIgnoreCase("fnum")){
								user.setFnum(StringUtils.toInt(xmlParser.nextText()));
							}else if(tag.equalsIgnoreCase("integral")){
								user.setIntegral(StringUtils.toInt(xmlParser.nextText()));
							}else if(tag.equalsIgnoreCase("rank")){
								user.setRank(StringUtils.toInt(xmlParser.nextText()));
							}
