package net.oschina.app.v2.model.popupbuttonlibrary;

import net.oschina.app.v2.model.popupbuttonlibrary.inter.PopupButtonListener;
        ...
        this.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if(popupWindow == null) {
                    ...
                    //layout.setBackgroundColor(0xFFD8D9DB);
