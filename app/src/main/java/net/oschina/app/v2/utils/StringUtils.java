...
public class StringUtils {
	...
	public static Date toDate(String sdate) {
		try {
			...
			return dateFormater.get().parse(d);
	...
	public static String getShowSingleLineStr(String string) {
		try {
			if (string.length() > 64) {
				String singleLine = string.substring(0, 63);
				return singleLine + "...";
			} else {
				return string;
			}
	...
	public static String getShowSingleLineWithHighlight(String content,String highLightStr){
		try{
			String str = getShowSingleLineStr(content);
			...
			for(String highStr:strList){
				content=content.replaceAll(highStr, "<font color=#2FBDE7>"+highStr+"</font>");
			}
	...
	public static String getStringWithOmit(String str,int beginOmit){
		try {
			if (str.length() > beginOmit) {
				String singleLine = str.substring(0, beginOmit-1);
				return singleLine + "...";
			} else {
				return str;
			}
